 ...
 * This class extends PlantGUI and provides specific animations and behavior for a Sunflower plant,
...
public class SunflowerGUI extends PlantGUI {
    ...
    /**
     * Constructs a SunflowerGUI object with the specified position and size.
     ...
     */
    public SunflowerGUI(int xPosition, int yPosition, int width, int height) {
